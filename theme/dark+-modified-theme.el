;;; dark+-modified-theme.el --- Modified Visual Studio Code Dark+ theme -*- lexical-binding: t; -*-
...
;;; Commentary:
;; A complete port of the modified Visual Studio Dark+ theme.
...
(let ((class '((class color) (min-colors 89)))
      ...
      (accent            "#ffffff")
      (numeric           "#b5cea8")
      (mode-line-bg      "#444444") ; modified
      (mode-line-bg-dark "#1e1e1e") ; modified as bg1
      (line-num          "#838383")
      (builtin           "#C586C0")
      (keyword           "#569cd6")
      (const             "#4EC9B0")
...
(provide-theme 'dark+-modified)
(provide 'dark+-modified-theme)
